...
public:
    ...
    NETVAR(body, "CBaseAnimating", "m_nBody", int)
        ...
        constexpr Entity* getObserverTargetC() noexcept
    {
        ...
        NETVAR(ObserverTarget,"CCSPlayer", "m_hObserverTarget", unsigned long)
        NETVAR(stamina, "CCSPlayer", "m_flStamina", Vector)
        NETVAR(tickBase, "CBasePlayer", "m_nTickBase", int)
        NETVAR(aimPunchAngle, "CBasePlayer", "m_aimPunchAngle", Vector)
        NETVAR(m_flHealthShotBoostExpirationTime, "CCSPlayer", "m_flHealthShotBoostExpirationTime", float)
